...
<div class="form-group">
  <?php if (($form_element->show_title and $form_element->label_position == "top") or (!$form_element->show_title)) { ?>
    ...
    <select class="form-control">
      <?php if ($form_element->placeholder_text != "") { ?>
      <option><?php echo $form_element->placeholder_text; ?></option>
      <?php } else { ?>
      <option>Select</option>
      <?php } ?>
      <?php foreach($form_element->form_element_option as $form_element_option) { ?>
      <option <?=(isset($form_element_option->option_value) and $form_element->default_value == $form_element_option->option_value) ? "selected" : ""?>><?php echo $form_element_option->option_value; ?></option>
      <?php } ?>
    </select>
  <?php } else { ?>
    <?php if ($form_element->show_title) { ?>
