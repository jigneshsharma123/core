<form name="frmnewcancelbutton" method="post" action="<?php echo base_url(); ?>admin/custom_forms/<?php echo (isset($form_element) and isset($form_element->id)) ? 'updateelement' : 'createnewelement' ?>">
  ...
  <input type="hidden" name="sort_order" id="sort_order" value="100000" class="form-control">
