<form name="frmnewradiobutton" method="post" action="<?php echo base_url(); ?>admin/custom_forms/<?php echo (isset($form_element) and isset($form_element->id)) ? 'updateelement' : 'createnewelement' ?>">
...
<script>
  $("#add_options").click(function(){
      $("#options").append('<div class="input-group"><input class="form-control" name="options[]" type="text"><div class="input-group-addon" id="remove_component" style="cursor:pointer"><i class="fa fa-remove"></i></div>')
  })
