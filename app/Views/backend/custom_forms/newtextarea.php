<form name="frmnewtextarea" method="post" action="<?php echo base_url(); ?>admin/custom_forms/<?php echo (isset($form_element) and isset($form_element->id)) ? 'updateelement' : 'createnewelement' ?>">
  ...
  <div class="form-group">
    ...
    <input type="text" name="no_of_rows" id="no_of_rows" class="form-control" value="<?php echo (isset($form_element) and isset($form_element->no_of_rows)) ? $form_element->no_of_rows : '2' ?>">
  </div>
