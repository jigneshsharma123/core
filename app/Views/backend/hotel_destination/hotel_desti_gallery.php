      ...
      <div class="x_content">
        ...
        <?php foreach ($medias as $m){?>
          ...
          <div class="thumbnail">
            ...
            <img style="width: 100%; display: block;" src="<?php echo base_url(); ?>/uploads/hotel_destinations/destination_image/<?php echo $m['image'];?>" alt="" />
            <div class="mask">
              ...
              <a href="<?php echo base_url();?>/admin/hotel_gallery/delete/<?php echo $m['id'];?>" onclick="return confirm('Click OK to confirm deletion.')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete"><i class="fa fa-trash text-danger"></i></a>
            </div>
            </div>
            </div>
